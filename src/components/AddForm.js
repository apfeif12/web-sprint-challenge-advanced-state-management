...
import { addSmurfs, fetchSmurfAddError } from "../actions/index.js";
...
const AddForm = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            props.fetchSmurfAddError(
                "Error: Name, position, and nickname are required fields."
            );
        } else {
...
export default connect(mapStateToProps, { addSmurfs, fetchSmurfAddError })(
    AddForm
);
